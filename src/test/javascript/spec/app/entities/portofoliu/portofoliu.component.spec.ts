...
import { PortofoliuComponent } from 'app/entities/portofoliu/portofoliu.component';
...
describe('Component Tests', () => {
  describe('Portofoliu Management Component', () => {
    let comp: PortofoliuComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PortofoliuComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(PortofoliuComponent);
      comp = fixture.componentInstance;
      service = fixture.debugElement.injector.get(PortofoliuService);
    });
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.portofolius[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
