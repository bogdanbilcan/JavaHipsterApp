...
import { StocComponent } from 'app/entities/stoc/stoc.component';
import { StocService } from 'app/entities/stoc/stoc.service';
import { Stoc } from 'app/shared/model/stoc.model';

describe('Component Tests', () => {
  describe('Stoc Management Component', () => {
    let comp: StocComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(StocComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(StocComponent);
      comp = fixture.componentInstance;
      service = fixture.debugElement.injector.get(StocService);
    });
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.stocs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
